			...
			"history": [
				{
					...
					"num_records": 0,
					"database": "nh4_test",
					"user_name": "NH4 Developer",
					"result": "td://@/nh4_test/susie_daily_paid_convert_count_by_campaign",
					"url": "https://console.treasuredata.com/jobs/1111111",
					"hive_result_schema": "[[\"aggregate_date\", \"varchar\"], [\"campaign_id\", \"bigint\"], [\"campaign_name\", \"varchar\"], [\"channel\", \"varchar\"], [\"sub_channel\", \"varchar\"], [\"partner\", \"varchar\"], [\"sub_partner\", \"varchar\"], [\"bounty\", \"varchar\"], [\"cmp_id\", \"varchar\"], [\"promo_add_day\", \"bigint\"], [\"signup\", \"bigint\"], [\"paid_convert\", \"bigint\"]]",
					"organization": null,
